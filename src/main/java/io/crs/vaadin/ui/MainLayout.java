package io.crs.vaadin.ui;

import com.vaadin.flow.component.html.Label;
import io.crs.vaadin.ui.util.FontSize;
import io.crs.vaadin.ui.util.FontWeight;
...
import io.crs.vaadin.ui.components.navigation.bar.AppBar;
import io.crs.vaadin.ui.components.navigation.bar.TabBar;
import io.crs.vaadin.ui.components.navigation.drawer.NaviDrawer;
import io.crs.vaadin.ui.components.navigation.drawer.NaviItem;
import io.crs.vaadin.ui.components.navigation.drawer.NaviMenu;
import io.crs.vaadin.ui.util.LumoStyles;
import io.crs.vaadin.ui.util.css.FlexDirection;
import io.crs.vaadin.ui.util.css.Overflow;
import io.crs.vaadin.ui.views.Accounts;
import io.crs.vaadin.ui.views.Home;
import io.crs.vaadin.ui.views.Payments;
import io.crs.vaadin.ui.views.Statistics;
import io.crs.vaadin.ui.views.personnel.Accountants;
import io.crs.vaadin.ui.views.personnel.Managers;

@HtmlImport("frontend://styles/shared-styles.html")
@Viewport("width=device-width, minimum-scale=1.0, initial-scale=1.0, user-scalable=yes")
@PWA(name = "VaadinStarter", shortName = "VaadinStarter", iconPath = "images/logo-18.png", backgroundColor = "#233348", themeColor = "#233348")
